//Suzuki is a monk who climbs the great staircase to the monastery as part of a ritual.
//Some days he climbs more stairs than others, depending on the number of students he has to train in the morning.
//He is curious to see how many steps he can climb in the next 20 years, and has spent the year tracking his daily progress.
//The sum of all the stairs climbed in a year will be used to estimate the number he can climb in 20.
//20_year_estimate = one_year_total * 20
//You will get the following data structure representing the stairs Suzuki has logged in a year. You will have all the
//data for the entire year, so no matter how it is logged, the problem should be easy to solve.
//stairs = [sunday,monday,tuesday,wednesday,thursday,friday,saturday]
//Make sure your solution takes into account all the nestings in the stairs array.
//Each day of the week in the stairs array is an array.
...
public class Kata {
    public static void main(String[] args) {
        ...
        System.out.println(stairsIn20_2(stairs)); //54636040
    }
    ...
    public static long stairsIn20_2(int[][] stairs) {
