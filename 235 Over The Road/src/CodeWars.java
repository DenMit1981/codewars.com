...
//upto 500 billion with over 200 random tests. If you try to store the addresses of 500 billion houses in
//a list then you will run out of memory and the tests will crash. This is not a kata problem so please don't post an
//issue. Similarly if the tests don't complete within 12 seconds then you also fail.
...
public class CodeWars {
    public static void main(String[] args) {
        ...
        System.out.println(overTheRoad(3, 3)); //4
        System.out.println(overTheRoad(2, 3)); //5
        System.out.println(overTheRoad(3, 5)); //8
        System.out.println(overTheRoad(7, 11)); //16
        System.out.println(overTheRoad(20, 1000000)); //1999981
        System.out.println(overTheRoad(23633656673L, 310027696726L)); //596421736780
    }
